...
**Updated:** 2026-08-06 · **Active:** every `critical` and `high` defect is closed; next are the `medium` ones (`M3-T05`, `M3-T08`, `M3-T13`, `M3-T14`). `M3-T02`, `M3-T20`, `M3-T17`, `M3-T12` closed 2026-08-06, `M3-T09`, `M3-T10`, `M3-T21` and `B-058` on 2026-08-05
