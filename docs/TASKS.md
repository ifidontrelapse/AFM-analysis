...
**Updated:** 2026-08-07 · **Active:** every `critical` and `high` defect is closed, and D-13 and D-15 with them; next are `M3-T14` and `M3-T15`. `M3-T08` and `M3-T13` closed 2026-08-07, `M3-T02`, `M3-T20`, `M3-T17`, `M3-T12`, `M3-T05` on 2026-08-06, `M3-T09`, `M3-T10`, `M3-T21` and `B-058` on 2026-08-05
