...
**Updated:** 2026-08-07 · **Active:** **every numerical defect the audit reproduced is closed** (D-16/D-17 with M3-T14); what is left in M3 is `M3-T15` (the evaluation harness), `M3-T16` (blocked on B6) and `M3-T19` (low). `M3-T08`, `M3-T13` and `M3-T14` closed 2026-08-07, `M3-T02`, `M3-T20`, `M3-T17`, `M3-T12`, `M3-T05` on 2026-08-06, `M3-T09`, `M3-T10`, `M3-T21` and `B-058` on 2026-08-05
